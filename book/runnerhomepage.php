...
<style>
  ...
  <body>
    ...
    <div id="navbar" class="topnav">
      ...
      <a class="active" href="runnerhomepage.php">Delivery Request</a>
  ...
  <section>
      <div>
        ...
        <?php 
          ...
          $result = $link->query("SELECT * FROM  bookOrder inner join book inner join student inner join tracking WHERE bookOrder.bookID = book.bookID AND bookOrder.studentID = student.studentID AND bookOrder.orderID = tracking.orderID AND bookOrder.paid = 'yes' AND runnerStatus = 'Waiting for Pickup'");
          ...
          ?> 
            ...
            <td><label>
              ...
              <td>
                <form action="acceptdelivery.php" style="text-align:center">
                  <input type="hidden" name="orderID" value="<?=$row['orderID']?>"> 
                  <input type="submit" id="btn" name="Accept Delivery" value="Accept Delivery" />
                </form>
              </td>
            </tr>
          <?php endwhile; ?>
