...
<style>
  ...
  <body>
    ...
    <a class="active" href="runnermonthselection.php">Report</a>
  ...
  <div>
      ...
      <label for="month">RUNNER SALARY</label>
      ...
      var data = google.visualization.arrayToDataTable([
        ...
        $result = $link->query("SELECT SUM(salary) AS total, trackingDate FROM tracking WHERE runnerID = '$runnerID' and customerStatus = 'Received' and Month(trackingDate) = '$month' group by Day(trackingDate)");


        while($row = $result->fetch_assoc()):
        ?>                
                ['<?php echo $row['trackingDate'] ?>', <?php echo $row['total']; ?> ],
